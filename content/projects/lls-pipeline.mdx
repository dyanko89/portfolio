...
cardDisplay:
  ...
  content: |
    ...
    [muted]  → 341 cached (hash match)
    [accent]  → 43 new/modified products
    [05:00:05] Generating AI descriptions...
    [muted]  → Model: claude-3-haiku
    [muted]  → 43 descriptions queued
    ✓ 43/43 generated ($0.27)
    [05:00:14] Updating Google Sheets...
    [muted]  → 384 rows synced
    [muted]  → 43 descriptions updated
    ✓ Spreadsheet updated
    [05:00:16] Sending notification...
    ✓ Email sent to 3 stakeholders
    [success]
    [success] ── Weekly Sync Complete ──
    [success]  Products: 384 │ New: 43 │ Cache: 89%
    [success]  AI cost: $0.27 │ Duration: 22s
client: LLS
results:
  - value: "100+"
...
Runs every Monday at 5 AM on personal infrastructure. Pulls the full product catalog from WordPress, generates marketing descriptions for new or changed products with Claude, updates a shared Google Sheet, and emails the sales team a summary.
