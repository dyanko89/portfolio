...
techStack:
  ...
  - category: "Testing"
    items: ["Vitest (796 tests, two backends)", "Zero-LLM replay harness", "Dirty-corpus drill (live local LLM)", "Retrieval eval (P@K, MRR, NDCG)"]
...
- **796-test regression suite** across both backends, plus a zero-LLM replay harness, a dirty-corpus drill against a live local LLM, and adversarial GATE reviews against a copy of real data
