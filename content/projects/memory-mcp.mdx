...
Three-tier semantic deduplication prevents near-duplicate creation: similarity ≥ 0.95 reinforces the existing memory, 0.85–0.95 reinforces and logs new evidence, below 0.85 creates a new entry.
