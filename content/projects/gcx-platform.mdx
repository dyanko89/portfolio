...
summary: Complete platform rebuild for B2B2C trading with 52 database tables, 77 foreign key relationships, multi-currency support, and full regulatory compliance infrastructure.
tags: ["React", "Node.js", "TypeScript", "SQL Server", "REST API"]
status: In Development
image: /images/projects/gcx-platform.png
results:
  - value: "52"
