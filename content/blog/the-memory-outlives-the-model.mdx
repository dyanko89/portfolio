...
summary: "A design exercise (an AI companion that grows with one child for twelve years) cornered me into a conclusion about all personal AI: memory is the persistent layer, models are interchangeable clients, and the keys should belong to the person the memory is about."
