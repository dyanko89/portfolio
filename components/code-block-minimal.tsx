...
export function CodeBlockMinimal({ code, language, children }: CodeBlockMinimalProps) {
  ...
  return (
    <div className="group relative w-full rounded-[2px] bg-[#1a2329] border border-[#2a3942]/50 hover:border-[#3d4f5c] transition-all duration-300 overflow-hidden code-block-minimal">
      ...
      <div className="code-block-content overflow-x-auto p-4 text-xs font-mono font-normal text-[#e8edef] leading-relaxed scrollbar-thin scrollbar-track-transparent scrollbar-thumb-[#2a3942] hover:scrollbar-thumb-[#ff5722] transition-colors bg-[#0f1519]">
        {children}
      </div>
    </div>
  )
